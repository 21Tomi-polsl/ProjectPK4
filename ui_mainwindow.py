...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.predict.setGeometry(QRect(240, 340, 111, 41))
        self.predict.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        ...
        self.trainModel.setGeometry(QRect(360, 240, 111, 41))
        ...
        self.modelLabel.setGeometry(QRect(100, 220, 171, 41))
        ...
        self.chooseModel.setGeometry(QRect(100, 260, 111, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.exportBox.setText(QCoreApplication.translate("MainWindow", u"Export CSV", None))
        self.modelLabel.setText(QCoreApplication.translate("MainWindow", u"Choose model type", None))
        self.chooseModel.setItemText(0, QCoreApplication.translate("MainWindow", u"LSTM", None))
        self.chooseModel.setItemText(1, QCoreApplication.translate("MainWindow", u"Regresja liniowa", None))
        self.chooseModel.setItemText(2, QCoreApplication.translate("MainWindow", u"Random Forest", None))
